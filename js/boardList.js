...
function filterTask(){
    ...
    let filterTasks = boardList.lists.map(list => {
        ...
        if (completeCheckbox.checked && incompleteCheckbox.checked) filteredTasks = filteredTasks.filter(task => task.is_completed || !task.is_completed)
        else if (completeCheckbox.checked) filteredTasks = filteredTasks.filter(task => task.is_completed)
        else if (incompleteCheckbox.checked) filteredTasks = filteredTasks.filter(task => !task.is_completed)
